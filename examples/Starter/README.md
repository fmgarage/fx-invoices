...
Rabatte und Zuschäge – sowohl auf Rechnungs- als auf Positionbasis – können mehrfach hinzugefügt werden, ein interner Zähler erstellt im JSON ein entsprechendes Array. 
